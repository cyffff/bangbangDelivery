...
const DB_HOST = process.env.SPRING_DATASOURCE_URL || 'jdbc:mysql://mysql:3306/bangbang_order?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=UTC&createDatabaseIfNotExist=true';
...
module.exports = (async () => {
  try {
    ...
    // Import models
    db.Order = require('./order.model')(db.sequelize, Sequelize);
    db.OrderItem = require('./orderItem.model')(db.sequelize, Sequelize);
